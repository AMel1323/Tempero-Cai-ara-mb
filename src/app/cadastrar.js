  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.label}>Nome:<Octicons name="feed-person" size={15} color="#C3A31B" style={{
        ...
        <Text style={styles.label}>E-mail:<FontAwesome name="envelope" size={15} color="#C3A31B" style={{
                    textShadowColor: 'rgba(207, 199, 199, 0.75)',
                    textShadowOffset: { width: 1, height: 1 },
                    textShadowRadius: 1,
                    marginLeft: 6
        ...
        <TouchableOpacity style={styles.loginButton} onPress={() => router.push("/cadastrofinal")}>
